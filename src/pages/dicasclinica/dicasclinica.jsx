...
const DicasClinica = () => {
  ...
  const handleCriarDica = async (e) => {
    e.preventDefault();
    if (!dica.titulo || !dica.conteudo || !dica.id_categoria) {
      setError('Preencha todos os campos obrigatórios');
      return;
    }

    const formData = new FormData();
    formData.append('titulo', dica.titulo);
    formData.append('conteudo', dica.conteudo);
    formData.append('id_categoria', dica.id_categoria);
    if (dica.imagem) {
      formData.append('imagem', dica.imagem);
    }
